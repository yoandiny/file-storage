package mg.yoan.file.endpoint.event.consumer;
...
import mg.yoan.file.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("mg.yoan.file.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "mg.yoan.file.service.event." + typeNameAsArray[typeNameAsArray.length - 1] + "Service";
  }
